.PHONY: help dev dev-backend dev-frontend install test test-backend test-frontend lint lint-backend lint-frontend typecheck quality build build-frontend db-migrate db-seed db-backup db-restore docker-up docker-down clean
