...
| AuditLogs.test.tsx | 6/6 | 审计日志列表、筛选、分页 |
...
| OrderDetail.test.tsx | 30/30 | 订单详情、确认/取消/冲正、收款弹窗、canViewCost、导航 |
| OrderForm.test.tsx | 32/32 | 新建/编辑订单、添加商品、提交创建/更新、商品选择器 |
| Orders.test.tsx | 15/15 | 订单列表、导航、状态筛选、搜索、日期格式 |
| Payments.test.tsx | 6/6 | 收款列表、状态筛选、创建/冲正 |
| ProductForm.test.tsx | 35/35 | 新增/编辑商品、图片上传成功/失败、高级设置、提交创建/更新 |
| Products.test.tsx | 14/14 | 商品列表、导航、删除/停用、CSV 导入、图片渲染 |
